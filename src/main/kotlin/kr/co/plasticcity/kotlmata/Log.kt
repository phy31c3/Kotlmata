...
internal class Logs
{
	companion object
	{
		...
		const val DAEMON_REGISTER_ON_CREATE = "Daemon[%s]:         on create registered"
		const val DAEMON_REGISTER_ON_START = "Daemon[%s]:         on start registered"
		const val DAEMON_REGISTER_ON_PAUSE = "Daemon[%s]:         on pause registered"
		const val DAEMON_REGISTER_ON_STOP = "Daemon[%s]:         on stop registered"
		const val DAEMON_REGISTER_ON_RESUME = "Daemon[%s]:         on resume registered"
		const val DAEMON_REGISTER_ON_FINISH = "Daemon[%s]:         on finish registered"
		const val DAEMON_REGISTER_ON_DESTROY = "Daemon[%s]:         on destroy registered"
		...
		const val DAEMON_ON_START = "Daemon[%s]:     onStart(payload: %s)"
		const val DAEMON_ON_PAUSE = "Daemon[%s]:     onPause(payload: %s)"
		const val DAEMON_ON_STOP = "Daemon[%s]:     onStop(payload: %s)"
		const val DAEMON_ON_RESUME = "Daemon[%s]:     onResume(payload: %s)"
		...
		const val DAEMON_END_REQUEST = "Daemon[%s]: } %sms"
