...
internal class Logs
{
	companion object
	{
		...
		const val MACHINE_START_MODIFY = "%s >> Modify {current state: %s}"
		const val MACHINE_END_MODIFY = "%s << Modify {current state: %s}"
		const val MACHINE_START_INPUT = "%s >> Input signal {signal: %s, payload: %s} {current state: %s}"
		const val MACHINE_END_INPUT = "%s << Input signal {signal: %s, payload: %s} {current state: %s}"
		const val MACHINE_START_TYPED_INPUT = "%s >> Input typed signal {signal: %s, type: %s, payload: %s} {current state: %s}"
		const val MACHINE_END_TYPED_INPUT = "%s << Input typed signal {signal: %s, type: %s, payload: %s} {current state: %s}"
