...
internal class Logs
{
	companion object
	{
		...
		const val KOTLMATA_INPUT = "Kotlmata:%s Signal input. {signal: %s, payload: %s, priority: %s} {daemon: %s}"
		const val KOTLMATA_TYPED_INPUT = "Kotlmata:%s Typed signal input. {signal: %s, type: %s, payload: %s, priority: %s} {daemon: %s}"
		...
		const val MACHINE_START_INPUT = "%s >> Start signal input. {signal: %s, payload: %s} {current state: %s}"
		const val MACHINE_END_INPUT = "%s << End signal input. {signal: %s, payload: %s} {current state: %s}"
		const val MACHINE_START_TYPED_INPUT = "%s >> Start typed signal input. {signal: %s, type: %s, payload: %s} {current state: %s}"
		const val MACHINE_END_TYPED_INPUT = "%s << End typed signal input. {signal: %s, type: %s, payload: %s} {current state: %s}"
